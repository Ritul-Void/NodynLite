...
let currentOllamaBaseUrl = 'http://127.0.0.1:11434'; 
let db = null;
...
document.getElementById('saveSettings').addEventListener('click', async () => {
  ...
  if (selectedEmbeddingModel !== currentModel) {
    ...
    try {
     // console.log('Switching embedding model to:', currentModel); // <-- Add this line
     ...
     // console.log('Embedding model initialized:', currentModel); // <-- Add this line
    } catch (e) {
